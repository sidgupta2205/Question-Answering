...
def get_setup_args():
    ...
    parser.add_argument('--train_url',
                        type=str,
                        default='https://github.com/sidgupta2205/Question-Answering/blob/main/../data/train-v2.0.json')
    parser.add_argument('--dev_url',
                        type=str,
                        default='https://github.com/sidgupta2205/Question-Answering/blob/main/../data/dev-v2.0.json')
    parser.add_argument('--test_url',
                        type=str,
                        default='https://github.com/sidgupta2205/Question-Answering/blob/main/../data/test-v2.0.json')
